...
<html lang="en">
  <head>
    ...
    <style type="text/css">
      ...
      <link href="/cadsimples/frontend/css/bootstrap.min.css" rel="stylesheet">
      <link href="/cadsimples/frontend/css/design.css" rel="stylesheet">
  ...
  <div class="container-fluid navbar-measures">
    <div class="navbar-header navbar-measures">
       ...
       <div class="div-fmt2 navbar-marginup-items">
          <a href="#" class="btn btn-menu-color" id="menu-toglle">
             ...
             <div id="sidebar-wrapper" class="zz-dex1">
                <div class="sidebar-ul">
                    <ul class="sidebar-nav">
                        ...
                        <li><a href="#"><span  class="glyphicon glyphicon-user sidebar-icons"></span> Cadastro</a></li>
                    </ul>
                </div>
              </div>
            <!-- / -->
